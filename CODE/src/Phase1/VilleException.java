...
public class VilleException {
    ...
    public static class ContrainteAccessibiliteException extends Exception{  //si les voisins de la ville n'ont pas une zone de recharge on ne peut pas lui retirer une zone de recharge
